        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRate = table.Column<decimal>(type: "decimal(22,6)", precision: 22, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceLog_Employee_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHours = table.Column<decimal>(type: "decimal(22,6)", precision: 22, scale: 6, nullable: false),
                    GrossSalary = table.Column<decimal>(type: "decimal(22,6)", precision: 22, scale: 6, nullable: false),
                    NetSalary = table.Column<decimal>(type: "decimal(22,6)", precision: 22, scale: 6, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayrollRecord_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRecord_EmployeeId",
                table: "PayrollRecord",
                column: "EmployeeId");
        }
